...
#define COAP_SAFE_DEFAULT_PORT  5684
#define COAP_DEFAULT_MAX_AGE     60 /* default maximum object lifetime in seconds */
#ifndef COAP_MAX_PDU_SIZE
#define COAP_MAX_PDU_SIZE      1152 /* maximum size of a CoAP PDU */
#endif /* COAP_MAX_PDU_SIZE */

#ifndef COAP_NORMAL_PDU_SIZE
#define COAP_NORMAL_PDU_SIZE      316 /* normal size of a CoAP PDU */
#endif /* COAP_NORMAL_PDU_SIZE */

#ifndef COAP_OPTION_BASIC_SIZE
#define COAP_OPTION_BASIC_SIZE  32
#endif
...
#define COAP_MAX_TOKEN_LEN     8 /*The maximum number of bytes for the Token*/
#define COAP_MAX_ETAG_LEN      8 /*The maximum number of bytes for the ETag*/
#define COAP_MAX_ACCEPT_NUM    2 /*The maximum number of accpet preferences to parse/store*/
...
#define COAP_OPTION_SIZE           28 /* E, uint, 0-4 B, (none) */
...
#define COAP_RESPONSE_204      COAP_RESPONSE_CODE(204)  /* 2.03 Not method */
#define COAP_RESPONSE_205      COAP_RESPONSE_CODE(205)  /* 2.05 Changed */
#define COAP_RESPONSE_402      COAP_RESPONSE_CODE(402)  /* 4.02 Bad Option */
#define COAP_RESPONSE_505      COAP_RESPONSE_CODE(505)  /* 5.05 Proxy not supported */
...
typedef struct _coap_pdu_ coap_pdu_t;
typedef void (*coap_confirmable_callback)(void *context, coap_pdu_t *pdu,  int flag);
struct _coap_pdu_{
...
void
coap_pdu_add_ref(coap_pdu_t *pdu) ;
