...
#define COAP_RESOURCE_FLAGS_STATIC_URI     0x0 /**<Indicate the uri is a static string,when
                                                delete resource,don't need to free() the uri.>**/
#define COAP_RESOURCE_FLAGS_MALLOC_URI     0x1 /**<Indicate the uri is a malloc string,when
                                                delete resource,need to free() the uri.>**/
#define COAP_RESOURCE_FLAGS_NOTIFY_NON     0x0
#define COAP_RESOURCE_FLAGS_NOTIFY_CON     0x2
#define COAP_RESOURCE_FLAGS_BASE_URI_PATH  0x4
#define COAP_RESOURCE_FLAGS_ROOT           0x8
...
coap_resource_t *coap_root_resource_init(void) ;
...
int coap_add_root_resource(coap_context_t *context, coap_resource_t *resource);
